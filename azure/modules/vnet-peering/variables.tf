...
#source peering variables 

variable "source_name" {
  type        = string
  description = "The name of the virtual network peering starts from"
  default     = "vpn"
}
...
# Target peering variables 

variable "target_name" {
  type        = string
  description = "The name of the virtual network peering ends to"
}
