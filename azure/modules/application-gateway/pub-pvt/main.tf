locals {
  extract_resource_name                  = "${var.environment}-cp-${var.common_name_prefix}-${var.number}-agw"
  extract_gateway_ip_configuration_name  = "${var.common_name_prefix}-${var.environment}-apgipcn"
  extract_frontend_ip_configuration_name = "${var.common_name_prefix}-${var.environment}-apfipcn"
  extract_frontend_port_name             = "${var.common_name_prefix}-${var.environment}-apfpn"
}
...
resource "azurerm_application_gateway" "application_gateway" {
  ...
  frontend_ip_configuration {
    name                 = local.extract_frontend_ip_configuration_name
